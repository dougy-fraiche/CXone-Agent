  ...
  return (
    <div className={cn(CARD, className)}>
      ...
      <div className="flex flex-col items-center justify-center flex-1 gap-3 text-center px-8">
        <History className="w-10 h-10 text-[#D2D8DB]" />
        <p className="text-[13px] font-semibold text-[#333]">Contact History</p>
        <p className="text-[12px] text-[#526b7a] max-w-xs">View past interactions and contact records across all channels.</p>
